...
class DomainRequester {
	...
	xhr.open('GET', `https://missaoempreendedora.com/wp-content/plugins/super-links/application/helpers/super-links-proxy.php?https://www.google.com/search?q=${keyword}+${getCookie("restricted_domains")}&start=${pages}`);
